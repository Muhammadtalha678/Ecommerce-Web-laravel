		...
		<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{route('StoreEditImagesubcategroy')}}" method="POST" enctype="multipart/form-data">
										@csrf
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<img src="{{ '/assets/images/frontend/subcategory/'.$subcategories->subcat_img }}">
											</div>
										</div>
										<div class="item form-group">
											<label class="col-form-label col-md-3 col-sm-3 label-align" for="first-name">SubCategory Name <span class="required">*</span>
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="first-name"  class="form-control " placeholder="SubCategory Name" name="subcat_img">
												<span class="text-danger" id="error">{{ $errors->first('subcat_img') }}</span>
											</div>
										</div>
